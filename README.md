...
|---|---|---|---|
| 1 | **Base XGBoost** | 5-fold `KFold` | Tuned gradient-boosted trees; baseline only — plain K-fold *leaks* on this autocorrelated series |
...
> **Data is not included.** Kaggle competition data can't be redistributed — download `train.parquet`, `test.parquet`, and `sample_submission.csv` from the [competition data page](https://www.kaggle.com/competitions/drw-crypto-market-prediction/data) and place them in the repo root.
